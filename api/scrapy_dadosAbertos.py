...
class DadosAbertos:
    ...
    def partidos(self): 
      # /partidos
      link = self.url + 'partidos'+ '?itens=100'
      return self.get(link)
    ...
    def partido_id_membros(self,id):    
      # /partidos/{id}/membros
      link = self.url + 'partidos/' + str(id) + '/membros'
      return self.get(link)
    ...
    def help(self): 
        metodos = """ Métodos da class  Dados Abertos:
                   ...
                   partido_id_membros(partido_id)         : Retorna todos os membros pertencentes ao partido
